...
private:
    ...
    void gen_safe_key(int key_length, char *path_to_save);
    void gen_weak_key(int key_length, char *path_to_save);
    BIGNUM* max_factor(BIGNUM *number);
    bool is_strong_prime(BIGNUM *prime);
